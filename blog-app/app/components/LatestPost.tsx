  ...
  return (
    <div className="bg-[#e6f0ff] border border-blue-100 p-6 md:p-10 rounded-xl mb-16 flex flex-col-reverse md:flex-row gap-6 md:gap-8 items-start shadow-sm">
      ...
      <div className="flex flex-col gap-4 text-left w-full md:w-1/2">
        <span className="bg-[#4f46e5] text-white text-xs font-semibold px-3 py-1 rounded-md w-max hidden sm:block">
          6 min read
        </span>
        ...
        <Link
          ...
          className="text-[#4f46e5] font-semibold text-sm hover:underline flex items-center gap-1"
        >
