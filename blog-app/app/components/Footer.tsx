export default function Footer() {
  return (
    ...
    <div className="max-w-6xl mx-auto mt-10 pt-6 border-t border-gray-700 text-sm text-gray-400 flex flex-col md:flex-row justify-between items-center gap-4">
